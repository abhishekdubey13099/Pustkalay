    ...
    return (
        <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
            <div className="text my-5">
                ...
                <p className="text-2xl my-7 px-1 dark:text-slate-300">Pustkalay is the world's most popular and authoritative source of ebooks. Find ratings and access to the newest books digitally.</p>
            ...
            <div className="visual my-5 lg:max-w-xl">
                <img className="rounded-lg max-h-full" src="https://images.unsplash.com/photo-1506377872008-6645d9d29ef7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="Pustkalay Hero Section" />
            </div>
        </section>
    )
}
